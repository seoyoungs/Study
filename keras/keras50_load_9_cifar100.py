...
modelpath9 = '../data/modelCheckpoint/k50_9_mnist_{epoch:02d}-{val_loss:.4f}.hdf5'
#02d 정수로 두번째 자리 까지, 4f 실수로 4번째 자리까지
#따라서 0.01이면 02d: 01, 4f : 0100이된다. k45_mnist_0100.hdf5
es= EarlyStopping(monitor='val_loss', patience=5)
cp =ModelCheckpoint(filepath=modelpath9, monitor='val_loss',
...
hist = model.fit(x_train,y_train, epochs=5, batch_size=16, verbose=1,
