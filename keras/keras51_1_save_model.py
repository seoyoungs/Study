...
model.save('../data/h5/k51_1_model1.h5')  #2. 모델링 까지 저장
...
hist = model.fit(x_train,y_train, epochs=15, batch_size=16, verbose=1,
                 validation_split=0.2,callbacks=[es, cp])

model.save('../data/h5/k51_1_model2.h5') #fit까지
