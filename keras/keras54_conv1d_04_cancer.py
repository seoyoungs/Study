...
print(np.argmax(y_pred, axis=1)) # y_pred로 코딩한 값
...
conv1d
loss: 0.5810 - acc: 0.7284 - mae: 0.4113
[0.5809515118598938, 0.7283626198768616, 0.4113316237926483]
'''