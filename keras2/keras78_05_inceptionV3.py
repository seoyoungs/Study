...
from tensorflow.keras.layers import Dense, Flatten, UpSampling2D, GlobalAveragePooling2D, Input
...
# ============== 모델링 =====================
inceptionV3.trainable = False # 훈련을 안시키겠다, 저장된 가중치 사용
inceptionV3.summary()
...
model.add(inceptionV3) # 3차원 -> layer 26개
model.add(Flatten())
model.add(Dense(10))
model.add(Dense(5))
