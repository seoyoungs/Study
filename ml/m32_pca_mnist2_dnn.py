...
pca = PCA(n_components=660) # 파라미터 주성분 개수 
...
print(y2_test.shape, x2_test.shape) # (14000,) (14000, 660)
print(y2_train.shape, x2_train.shape) #  (56000,) (56000, 660)

#2. 모델 구성
from tensorflow.keras.models import Sequential
from tensorflow.keras.layers import Dense, LSTM
model=Sequential()
model.add(Dense(units=12, activation='relu', input_shape=(660,)))
