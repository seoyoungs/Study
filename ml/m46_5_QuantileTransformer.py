...
# https://tensorflow.blog/2018/01/14/quantiletransformer/ QuantileTransformer이 정규분포 따르는 증거
...
scaler = QuantileTransformer(output_distribution='normal') # 정규분포(평균0, 표준편차1)
