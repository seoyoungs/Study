...
# -------------- L2
w2 = tf.get_variable('w2', shape=[3, 3, 64, 64]) # 첫번째 아웃풋이 두번째 인풋  
...
# --------------- L3
w3 = tf.get_variable('w3', shape=[3, 3, 64, 128]) # 첫번째 아웃풋이 두번째 인풋  
...
# --------------- L4
w4 = tf.get_variable('w4', shape=[3, 3, 128, 64]) # 첫번째 아웃풋이 두번째 인풋  
